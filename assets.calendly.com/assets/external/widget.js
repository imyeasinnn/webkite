(() => {
    ...
    (() => {
        ...
        class h {
            ...
            inject() {
                return this.build(), this.format(), this.attachDeferredPrefillPostMessage(), "inline" === this.embedType.toLowerCase() && this.resize && this.attachResizeListener(), this.parent.appendChild(this.buildSpinner()), this.parent.appendChild(this.node)
            }
            parseOptions() {
            ...
            getDeferredPrefillPayload() {
                ...
                const {
                    prefill: e
                } = this.options, t = r(e, ["name", "firstName", "lastName", "email"]), o = n(t, ((e, t) => i(t)));
                ...
                return Array.isArray(e.guests) && e.guests.length > 0 && (o.guests = e.guests.filter(Boolean)), Object.keys(o).length > 0 ? o : null
            }
        ...
        class j {
                    ...
                    if (e) {
                        if (!v.some((function(t) {
                            ...
                            v = [].concat(function(e) {
                                ...
                                return Array.from(e)
                            }(v), [o]), b ? window.requestAnimationFrame((function() {
                                if (void 0 === C) {
                                    C = {
            ...
            unlockPageScroll() {
                var e;
                return (e = this.overlay) ? (v = v.filter((function(t) {
                    return t.targetElement !== e
                })), b && (e.ontouchstart = null, e.ontouchmove = null, f && 0 === v.length && (document.removeEventListener("touchmove", S, y ? {
                    passive: !1
                } : void 0), f = !1)), b ? function() {
                    if (void 0 !== C) {
                ...
                o((() => (e => {
                    ...
                    const t = (e => {
                        ...
                        o = ((e, t) => {
                            ...
                            if (A)
                                for (var o of A(t)) B.call(t, o) && M(e, o, t[o]);
                            return e
                        })({
                            onClick: () => _(e.url, "PopupWidget", e)
                        }, t);
